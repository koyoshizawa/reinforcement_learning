...
model = model_from_json(open('dqn_myenv-v0_model.json').read())
model.load_weights('dqn_myenv-v0_weights.h5f')
...
for _ in range(Episodes):
    ...
    while not done:
        ...
        print(model.predict_proba(numpy.array([[make_obs(data, read_index)]])))
